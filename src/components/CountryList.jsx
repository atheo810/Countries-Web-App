...
import CountryCard from "./CoutnryCard";
...
export default function CountryList({ filters }) {
  ...
  if (loading) {
    return (
      <p className="max-w-6xl mx-auto px-6 py-16 text-center text-steel">
        Memuat data negara...
      </p>
    );
  }
  ...
  if (error) {
    return (
      <p className="max-w-6xl mx-auto px-6 py-16 text-center text-red-400">
